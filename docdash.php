      ...
      dateInput.value = this.value;
            ...
            <div class="baby-gallery-card">
              ...
              <div class="baby-mosaic-grid">
                <a href="baby_profile.php?id=1" class="baby-card-link">
                  <div class="mosaic-item square" data-name="Baby Book 1">
                    <img src="https://www.w3schools.com/w3images/fjords.jpg" alt="Baby Book 1" class="mosaic-image">
                  </div>
                </a>
                <a href="baby_profile.php?id=2" class="baby-card-link">
                  <div class="mosaic-item square" data-name="Baby Book 2">
                    <img src="https://www.w3schools.com/w3images/lights.jpg" alt="Baby Book 2" class="mosaic-image">
                  </div>
                </a>
                <a href="baby_profile.php?id=3" class="baby-card-link">
                  <div class="mosaic-item square" data-name="Baby Book 3">
                    <img src="https://www.w3schools.com/w3images/mountains.jpg" alt="Baby Book 3" class="mosaic-image">
                  </div>
                </a>
              </div>
            </div>
